...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="contact-area section-padding" data-v-88a9719c><div class="container min-vh-100" data-v-88a9719c><div class="row align-items-center justify-items-center py-5" data-v-88a9719c><div class="col-md-6 order-2 order-lg-1 order-md-1 mb-3 text-center" data-v-88a9719c><div data-v-88a9719c>`);
      ...
      _push(`</div><div class="mt-3" data-v-88a9719c><a href="#" data-v-88a9719c>Veja onde est\xE1 nossas unidades</a></div><a href="#unidades" data-v-88a9719c>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-chevrons-down",
        color: "var(--bs-primary)",
        fontSize: "3em"
      }, null, _parent));
      _push(`</a></div><div class="col-md-6 order-1 order-lg-2 mb-3" data-v-88a9719c>`);
      _push(ssrRenderComponent(_component_FormsFormContato, null, null, _parent));
      _push(`</div></div></div></div><section class="location-cards section-padding bg-primary" id="unidades" data-v-88a9719c><div class="container my-5" data-v-88a9719c><h2 class="text-center mb-5 text-light" data-v-88a9719c>Encontre a unidade mais pr\xF3xima</h2><div class="row" data-v-88a9719c><div class="col-md-4 mb-4" data-v-88a9719c><div class="card text-center" data-v-88a9719c><div class="card-body" data-v-88a9719c>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-88a9719c>Campinas</h5><a href="#" class="btn btn-link" data-v-88a9719c>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-88a9719c><div class="card text-center" data-v-88a9719c><div class="card-body" data-v-88a9719c>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-88a9719c>Ribeir\xE3o Preto</h5><a href="#" class="btn btn-link" data-v-88a9719c>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-88a9719c><div class="card text-center" data-v-88a9719c><div class="card-body" data-v-88a9719c>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-88a9719c>S\xE3o Jos\xE9 dos Campos</h5><a href="#" class="btn btn-link" data-v-88a9719c>Ver localiza\xE7\xE3o</a></div></div></div></div></div></section><!--]-->`);
    };
  }
});
...
const contato = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-88a9719c"]]);

export { contato as default };
//# sourceMappingURL=contato-DK9eOFOr.mjs.map
