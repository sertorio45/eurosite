import { _ as __nuxt_component_0$1, a as _sfc_main$2 } from './Footer-DJ4P2bKU.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "breadcrumbs-title parallax overlay dark-5 blank-space bg-primary text-center" }, _attrs))} data-v-29c86fcf><div class="container py-5" data-v-29c86fcf><div class="row" data-v-29c86fcf><div class="col-xs-12" data-v-29c86fcf><div class="breadcrumbs-menu" data-v-29c86fcf><h1 class="l-height text-center" data-v-29c86fcf>${ssrInterpolate(pageTitle.value)}</h1><nav aria-label="breadcrumb" data-v-29c86fcf><ul class="clearfix justify-content-center" data-v-29c86fcf><li class="breadcrumb-item" data-v-29c86fcf>`);
      ...
      if (breadcrumbs.value.length > 0) {
        _push(`<i class="zmdi zmdi-chevron-right" data-v-29c86fcf></i>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</li><!--[-->`);
      ssrRenderList(breadcrumbs.value, (crumb, index) => {
        _push(`<li class="breadcrumb-item" data-v-29c86fcf>`);
        if (crumb.path) {
          ...
          _push(`<span class="link-tow" data-v-29c86fcf>${ssrInterpolate(crumb.name)}</span>`);
        }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-29c86fcf"]]);
const _sfc_main = {};
...
//# sourceMappingURL=default-breadcrumb-DifAtBDY.mjs.map
