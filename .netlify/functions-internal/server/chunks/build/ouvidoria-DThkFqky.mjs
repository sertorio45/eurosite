...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button></div><span style="${ssrRenderStyle({ "font-size": "0.8em!important" })}" class="my-4"> Ao enviar o formul\xE1rio voc\xEA est\xE1 de acordo com nossa <a href="/politica-de-privacidade">Pol\xEDtica de Privacidade</a></span></div></form></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="ouvidoria-area section-padding d-flex justify-content-center align-items-center my-5" data-v-cb12d24e><div class="container d-flex justify-content-center align-items-center" data-v-cb12d24e><div class="row w-100" data-v-cb12d24e><div class="col-md-6 mb-3 mx-auto" data-v-cb12d24e>`);
      _push(ssrRenderComponent(_component_FormsFormOuvidoria, null, null, _parent));
      _push(`</div></div></div></div><section class="location-cards section-padding bg-primary" id="unidades" data-v-cb12d24e><div class="container" data-v-cb12d24e><h2 class="text-center mb-5 text-light" data-v-cb12d24e>Encontre a unidade mais pr\xF3xima</h2><div class="row" data-v-cb12d24e><div class="col-md-4 mb-4" data-v-cb12d24e><div class="card text-center" data-v-cb12d24e><div class="card-body" data-v-cb12d24e>`);
      ...
      _push(`<h5 class="card-title mt-3" data-v-cb12d24e>Campinas</h5><a href="#" class="btn btn-link" data-v-cb12d24e>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-cb12d24e><div class="card text-center" data-v-cb12d24e><div class="card-body" data-v-cb12d24e>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-cb12d24e>Ribeir\xE3o Preto</h5><a href="#" class="btn btn-link" data-v-cb12d24e>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-cb12d24e><div class="card text-center" data-v-cb12d24e><div class="card-body" data-v-cb12d24e>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-cb12d24e>S\xE3o Jos\xE9 dos Campos</h5><a href="#" class="btn btn-link" data-v-cb12d24e>Ver localiza\xE7\xE3o</a></div></div></div></div></div></section><!--]-->`);
    };
  }
});
...
const ouvidoria = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cb12d24e"]]);

export { ouvidoria as default };
//# sourceMappingURL=ouvidoria-DThkFqky.mjs.map
