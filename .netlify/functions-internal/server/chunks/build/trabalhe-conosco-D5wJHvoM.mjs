...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="trabalhe-conosco-area section-padding d-flex justify-content-center align-items-center my-5" data-v-e8308e23><div class="container d-flex justify-content-center align-items-center" data-v-e8308e23><div class="row w-100" data-v-e8308e23><div class="col-md-6 mb-3 mx-auto" data-v-e8308e23>`);
      _push(ssrRenderComponent(_component_FormsFormTrabalheConosco, null, null, _parent));
      _push(`</div></div></div></div><section class="location-cards section-padding bg-primary" id="unidades" data-v-e8308e23><div class="container my-5" data-v-e8308e23><h2 class="text-center mb-5 text-light" data-v-e8308e23>Encontre a unidade mais pr\xF3xima</h2><div class="row" data-v-e8308e23><div class="col-md-4 mb-4" data-v-e8308e23><div class="card text-center" data-v-e8308e23><div class="card-body" data-v-e8308e23>`);
      ...
      _push(`<h5 class="card-title mt-3" data-v-e8308e23>Campinas</h5><a href="#" class="btn btn-link" data-v-e8308e23>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-e8308e23><div class="card text-center" data-v-e8308e23><div class="card-body" data-v-e8308e23>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-e8308e23>Ribeir\xE3o Preto</h5><a href="#" class="btn btn-link" data-v-e8308e23>Ver localiza\xE7\xE3o</a></div></div></div><div class="col-md-4 mb-4" data-v-e8308e23><div class="card text-center" data-v-e8308e23><div class="card-body" data-v-e8308e23>`);
      _push(ssrRenderComponent(_component_Icon, {
        icon: "bx bx-map",
        fontSize: "5em",
        class: "icon-card",
      ...
      _push(`<h5 class="card-title mt-3" data-v-e8308e23>S\xE3o Jos\xE9 dos Campos</h5><a href="#" class="btn btn-link" data-v-e8308e23>Ver localiza\xE7\xE3o</a></div></div></div></div></div></section><!--]-->`);
    };
  }
});
...
const trabalheConosco = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e8308e23"]]);

export { trabalheConosco as default };
//# sourceMappingURL=trabalhe-conosco-D5wJHvoM.mjs.map
