...
import { u as useRuntimeConfig, e as eventHandler, s as setResponseHeader, a as send, g as getResponseStatus, b as setResponseStatus, f as setResponseHeaders, h as useNitroApp, j as joinRelativeURL, i as getQuery, c as createError, k as getRouteRules, l as getResponseStatusText } from '../runtime.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Descrição da GS Studio, uma agência especializada em design, marketing e tecnologia."},{"name":"format-detection","content":"telephone=no"},{"name":"keywords","content":"design, marketing, tecnologia, agência, GS Studio"},{"name":"robots","content":"index,follow"},{"name":"author","content":"GS Studio"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.svg"},{"key":"gf-prefetch","rel":"dns-prefetch","href":"https://fonts.gstatic.com/"},{"key":"gf-preconnect","rel":"preconnect","href":"https://fonts.gstatic.com/","crossorigin":"anonymous"},{"key":"gf-origin-preconnect","rel":"preconnect","href":"https://fonts.googleapis.com/"}],"style":[],"script":[{"key":"gf-script","children":"(function(){\n        var h=document.querySelector(\"head\");\n        var m=h.querySelector('meta[name=\"head:count\"]');\n        if(m){m.setAttribute('content',Number(m.getAttribute('content'))+1);}\n        else{m=document.createElement('meta');m.setAttribute('name','head:count');m.setAttribute('content','1');h.append(m);}\n        var l=document.createElement('link');l.rel='stylesheet';l.href='https://fonts.googleapis.com/css2?family=Josefin:wght@400;700&family=Poppins:wght@400;700&display=swap';h.appendChild(l);\n      })();"}],"noscript":[{"children":"<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Josefin:wght@400;700&family=Poppins:wght@400;700&display=swap\">","tagPosition":"bodyOpen"}]};
