import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { builder } from '@netlify/functions';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b335b00c-320d-4ca7-8b7c-6041c6575191",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/giovannisertorio/Desktop/Sites/euro/.data/kv"}));
...
const _Dq9HyK = defineEventHandler(async event => {
  try {
...
const _Bppk87 = lazyEventHandler(() => {
...
const _lazy_FabgGG = () => import('./routes/api/posts.mjs');
const _lazy_AVsQ3E = () => import('./routes/api/postsAlunosContratados.mjs');
const _lazy_G9gcHJ = () => import('./routes/api/postsCursos.mjs');
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_XCErEf, lazy: true, middleware: false, method: undefined },
  { route: '/mail/send', handler: _Dq9HyK, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _Bppk87, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XCErEf, lazy: true, middleware: false, method: undefined }
];
...
const handler = builder(lambda);

export { $fetch as $, encodePath as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, handler as E, send$1 as a, setResponseStatus as b, createError$2 as c, defineEventHandler$1 as d, eventHandler as e, setResponseHeaders as f, getResponseStatus as g, useNitroApp as h, getQuery as i, joinRelativeURL as j, getRouteRules as k, getResponseStatusText as l, hasProtocol as m, isScriptProtocol as n, joinURL as o, defu as p, sanitizeStatusCode$1 as q, createHooks as r, setResponseHeader as s, toRouteMatcher as t, useRuntimeConfig as u, createRouter$1 as v, withQuery as w, encodeParam as x, withLeadingSlash as y, parseURL as z };
