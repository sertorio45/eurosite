<template>
  <footer class="pt-0 pt-x-0">
    <div class="container py-5">
      <div class="row d-flex justify-content-center align-content-center">
        ...
        <div class="col-md-2 col-lg-3 py-sm-2">
          <NuxtImg 
        ...
        <div class="col-md-2">
          ...
          <ul class="list-unstyled">
            <li><NuxtLink to="/unidades/campinas">Campinas</NuxtLink></li>
            <li><NuxtLink to="/unidades/ribeirao-preto">Ribeirão Preto</NuxtLink></li>
            <li><NuxtLink to="/unidades/sao-jose-dos-campos">São José dos Campos</NuxtLink></li>
          </ul>
        </div>
    ...
    <div class="container" id="copyright">
        <div class="row align-items-center">
          <div class="col-lg-6 col-sm-12 col-md-6 text-md-start text-lg-start text-left">
            <p id="copyright-text"></p>
          </div>
          <div class="col-lg-6 col-sm-12 col-md-6 text-md-end text-lg-end text-left">
  ...
  onMounted(() => {
    ...
    const copyrightText = `Copyright © ${startYear} - ${currentYear} - Todos os direitos reservados.`;
